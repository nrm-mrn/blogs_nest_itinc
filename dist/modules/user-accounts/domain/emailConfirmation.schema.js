...
_export(exports, {
    ...
    get EmailConfirmationSchema () {
        return EmailConfirmationSchema;
    }
});
...
EmailConfirmation = _ts_decorate([
    (0, _mongoose.Schema)({
        _id: false
    })
], EmailConfirmation);
const EmailConfirmationSchema = _mongoose.SchemaFactory.createForClass(EmailConfirmation);
